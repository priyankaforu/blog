...
export function Hero({ profile }: HeroProps) {
  ...
  const data = profile || {
    ...
    socials: [
      {
        platform: "github",
        url: "https://github.com/priyankaforu",
        username: "priyankaforu",
      },
      {
        platform: "twitter",
        url: "https://x.com/priyankapudi",
        username: "@priyankapudi",
      },
      {
        platform: "linkedin",
        url: "https://linkedin.com/in/priyankapudi",
        username: "priyankapudi",
      },
    ],
  };
  ...
  return (
    <>
      ...
      <div
        className="flex items-center justify-between text-sm px-4 sm:px-6 pt-4 pb-6 w-full"
        style={{
      ...
      >
        <a
          href="https://www.timeanddate.com/worldclock/converter.html?iso=20260410T00&p1=44"
          target="_blank"
        ...
        <div className="flex items-center gap-1.5">
          ...
          <a
            href="https://www.google.com/maps/place/Vijayawada"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <section className="flex flex-col justify-start px-6 pt-2 pb-6 max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                <span className="w-6 h-6 flex items-center justify-center rounded border border-blue-500 hover:border-blue-400 transition-colors">
                  <i
                    className="bi bi-box-arrow-up text-sm"
        ...
        {/* Bio */}
        <div
          className="text-sm mb-4 leading-relaxed space-y-3"
          style={{ color: "var(--foreground)", opacity: 0.85 }}
        >
          <p>
            <span className="font-medium" style={{ color: "var(--accent)" }}>
              4 years of electrical engineering
            </span>{" "}
            taught me how systems work at their core.{" "}
            <span className="font-medium" style={{ color: "var(--accent)" }}>
              5 years in Germany
            </span>{" "}
            taught me how to build them for real users.
          </p>
          <p>
            I&apos;m a{" "}
            <span className="font-medium" style={{ color: "var(--accent)" }}>
            ...
            : from database design to deployment, auth to real-time features.
            I&apos;ve built and launched multiple products with{" "}
            <span className="font-medium" style={{ color: "var(--accent)" }}>
              paying customers
            </span>
            , and I pick up whatever stack the problem demands. Currently going
            deep on{" "}
            <span className="font-medium" style={{ color: "var(--accent)" }}>
              Applied AI
            </span>
            : building with LLMs, voice agents, and integrating AI into real
            products.
          </p>
          <p>
            I don&apos;t take months to deliver. I{" "}
            <span className="font-medium" style={{ color: "var(--accent)" }}>
              scope fast, build fast
            </span>
            , and communicate honestly throughout. Got a broken system at 2 AM?
            I&apos;ll fix that too.
          </p>
          <p>
            If you need someone who treats your product like their own and gets
            things out the door,{" "}
            <span className="font-medium" style={{ color: "var(--accent)" }}>
              let&apos;s talk
            </span>
        ...
        <div className="space-y-2">
          <p className="text-xs text-zinc-500">You can also find me here</p>
          <div className="flex flex-wrap gap-2">
            <div className="relative" data-email-popup>
              ...
              {showEmail && (
                <div className="absolute top-full left-0 mt-2 flex items-center gap-2 px-3 py-2 rounded-lg bg-[var(--card)] border border-[var(--border)] z-10 whitespace-nowrap cursor-pointer">
                  ...
                  >
                    <i
                      className={`bi ${copied ? "bi-check-lg text-green-400" : "bi-copy"} text-sm`}
                    />
                  </button>
                </div>
              )}
            ...
            {data.socials?.map((social) => {
              const iconClass =
                socialIconClasses[social.platform.toLowerCase()] || "bi-github";
              return (
                <a
                  key={social.platform}
                  href={social.url}
